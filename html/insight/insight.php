<?php
  require_once '../../php/insight/populateCal.php';
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Insight | Track emotions | griefSpace</title>
  ...
  <body class="fontInter">
    ...
    <section id="insightPanel" class="container page">
      <h1 class="heading">Insight</h1>

      <div class="insightWrapper">
        <div class="calWrapper flex justifyCenter">
          <div id='calendar'></div>
        </div>

        <div class="indicator flex flexColumn alignStart">
          <h3>What do those background colors mean?</h3>
          <div class="indicator-container flex">
            <div class="left">
              <div class="emotion-container flex alignCenter">
                <div class="color emotion-brown"></div>
                <p>Terrible</p>
              </div>
              <div class="emotion-container flex alignCenter">
                <div class="color emotion-blue"></div>
                <p>Bad</p>
              </div>
            </div>
            <div class="middle">
              <div class="emotion-container flex alignCenter">
                <div class="color emotion-white"></div>
                <p>Neutral</p>
              </div>
              <div class="emotion-container flex alignCenter">
                <div class="color emotion-yellow"></div>
                <p>Good</p>
              </div>
            </div>
            <div class="right">
              <div class="emotion-container flex alignCenter">
                <div class="color emotion-orange"></div>
                <p>Amazed</p>
              </div>
            </div>
          </div>
    ...
    <section class="bottomNav">
      <nav class="flex justifyEven alignCenter">
        ...
        <div class="navButton flex justifyCenter alignCenter flexColumn active">
          <a class="flex justifyCenter alignCenter flexColumn" href="./insight.php">
            <svg id="insightNavBtn" class="active" width="38" height="35" viewBox="0 0 38 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
  ...
  import { getJournalId } from '../../js/calendar/getJournalId.js';
