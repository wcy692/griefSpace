...
<html lang="en" dir="ltr">
  ...
  <body class="fontInter">
    ...
    <section id="changeEmailForm" class="changeForm settingConn container">
      <h1 class="heading">Change email</h1>
      <div class="wrapper">
        <form action="../../php/setting/account/changeEmail.php" method="post">
          <div class="textContainer">
            <h2 class="label">New email address</h2>
              <?php
              if (isset($_GET['email'])) {
                echo '<input type="text" name="email" value="'.$_GET['email'].'">';
              } else{
                echo '<input type="text" name="email" value="'.$row[0]['email'].'">';
              }
               ?>
          </div>
          <div class="textContainer">
            <h2 class="label">Enter your password</h2>
