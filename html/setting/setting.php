...
<html lang="en" dir="ltr">
  ...
  <body class="fontInter">
    ...
    <?php
      if (isset($_GET['email']) && $_GET['email'] == 'success') {
        echo '<div class="popup goodRequest">
        <svg class="closeBtn" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="20" cy="20" r="18.5" stroke="#525252" stroke-width="3"/>
        <line y1="-1" x2="14.1421" y2="-1" transform="matrix(0.707107 0.707107 -0.906804 0.421552 14 16)" stroke="#525252" stroke-width="2"/>
        <line y1="-1" x2="14.1421" y2="-1" transform="matrix(0.707107 -0.707107 -0.906804 -0.421552 14 25)" stroke="#525252" stroke-width="2"/>
        </svg>';
        echo '<h2>Good Request:</h2>
              <h3>You\'ve updated your email.</h3></div>';

      } elseif (isset($_GET['status']) && $_GET['status'] == 'sendErr') {
        ...
        echo '<h2>Bad Request:</h2>
              <h3>Something went wrong in the server. Please try again later.</h3></div>';
      }
     ?>
    ...
    <div class="outerWrapper">
      <section id="settingConn" class="slide settingConn container">
        <h1 class="heading">Settings</h1>
        <div class="wrapper">
          <h3 class="label">General</h3>
          <div id="toggleAccount" class="textContainer">
            <h2>Account</h2>
            <h3>Email address, username</h3>
          </div>
        </div>
        <div class="wrapper">
          <h3 class="label">Security</h3>
          <div id="togglePush" class="textContainer">
            <h2>Push Notifcation</h2>
            <h3>How we informed you when your contents are changed</h3>
          </div>
          <div id="toggleLogin" class="textContainer">
            <h2>Login Settings</h2>
            <h3>Login Alert, Email One-time password</h3>
          </div>
        </div>
        <form class="logoutForm" action="../../php/loginReg/login/logout.php" method="post">
          <button class="actionBtn secondBtn logoutBtn" type="submit" name="logoutBtn"><h5>Logout</h5></button>
        </form>
      </section>

      <!-- account panel -->
      <section id="account" class="slide settingConn container">
        <div class="rightBtnContainer flex justifyEnd">
          <img class="backToSetting" src="../../pic/icon/goBack.svg" alt="quit-question-selector">
        </div>
        ...
        <div class="wrapper">
          <form action="" method="post">
            <div class="textContainer">
              ...
              <?php
                echo '<input type="text" name="uid" value="'.$row[0]['uid'].'" readonly>';
               ?>
            </div>
            <div class="textContainer">
              <h2 class="label">Email address</h2>
                <?php
                  echo '<input type="text" name="email" value="'.$row[0]['email'].'" readonly>';
                 ?>
            </div>
            <div class="toggleForm">
              <h2 class="label">Wanna modify email?</h2>
              <button class="actionBtn" type="button"><a href="./changeEmail.php"><h5>Change email</h5></a></button>
            </div>
            <div class="toggleForm">
              <h2 class="label">Wanna change password?</h2>
              <button class="actionBtn" type="button"><a href="../resend/getResetPwdLetter.php"><h5>Change password</h5></a></button>
            </div>
          </form>
        </div>
      </section>
      ...
      <section id="push" class="slide settingConn container">
        <div class="rightBtnContainer flex justifyEnd">
          <img class="backToSetting" src="../../pic/icon/goBack.svg" alt="quit-question-selector">
        </div>
        <h1 class="heading">Push Notifcation</h1>
        <div class="wrapper">
          <h2 class="label">Which event would you like to receive our notification?</h2>
          <form>
            <!-- compulsory -->
            <div class=" textContainer flex flexColumn justifyCenter alignBetween">
              <div class="flex flex justifyBetween alignCenter">
                <h5>Activate account</h5>
                <div class="activatedSwtch switch"><div class="activatedCircle circle"></div></div>
              </div>
              <h2 class="label reminder">This setting is enabled by default.</h2>
            </div>
            <div class=" textContainer flex flexColumn justifyCenter alignBetween">
              <div class="flex flex justifyBetween alignCenter">
                <h5>Email changed</h5>
            ...
            <!-- optional setting -->
            <div id="journal_created" class="notiBtn textContainer flex justifyBetween alignCenter">
              <h5>Journal created</h5>
              <div class="switch"><div class="circle"></div></div>
            </div>
            <div id="journal_updated" class="notiBtn textContainer flex justifyBetween alignCenter">
              <h5>Journal updated</h5>
              <div class="switch"><div class="circle"></div></div>
            </div>
          </form>
          <h2 class="label">Notification will be sent via email.</h2>
        </div>
      </section>

      <!-- login settings panel -->
      <section id="loginSetting" class="slide settingConn container">
        <div class="rightBtnContainer flex justifyEnd">
          <img class="backToSetting" src="../../pic/icon/goBack.svg" alt="quit-question-selector">
        </div>
        ...
        <div class="wrapper">
          <form>
            <div id="loginAlert" class="loginSettingBtn textContainer flex flexColumn justifyCenter alignBetween">
              <div class="indicatorContainer flex justifyBetween alignCenter">
                <h5>Alert after login</h5>
                <div class="switch"><div class="circle"></div></div>
              </div>
              <h3>An alert email will be sent to your email inbox to alert the login activity.</h3>
            </div>

            <div id="oneTimePwd" class="loginSettingBtn textContainer flex flexColumn justifyCenter alignBetween">
              <div class="indicatorContainer flex justifyBetween alignCenter">
                <h5>One-time password</h5>
                <div class="switch"><div class="circle"></div></div>
              </div>
              <h3>An email containing a one-time password will be sent to your email inbox.</h3>
            </div>
          </form>
        </div>
      </section>
  ...
  <script type="text/javascript" src="../../js/setting/toggleNoti.js"></script>
  <script type="text/javascript" src="../../js/setting/toggleLoginSetting.js"></script>
  <script type="text/javascript" src="../../js/setting/slideConn.js"></script>
  <script type="text/javascript" src="../../js/setting/pushConn.js"></script>
  <script type="text/javascript" src="../../js/setting/loginSettingConn.js"></script>
