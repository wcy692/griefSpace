...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Journal | griefSpace</title>
  ...
  <body class="fontInter">
      ...
      if (isset($_GET['edit']) && $_GET['edit'] == 'success') {
        ...
        if ($status == 'success') {
          echo '<h2>Good Request:</h2>
                <h3>You\'ve just updated a journal.</h3>';
        }
        echo '</div>';
        ...
        if ($status == 'success') {
          echo '<h2>Good Request:</h2>
                <h3>You\'ve uploaded a new journal.</h3>';
        }
        echo '</div>';
      } elseif (isset($_GET['insert']) && $_GET['insert'] == 'timelimit') {
        ...
        echo '<h2>Time limit:</h2>
              <h3>You can only create one journal every day.</h3>';
        echo '</div>';
    ...
    <section class="container page">
      ...
      <div class="boxWrapper flex justifyStart">
        <div class="createBox box">
          <div class="preview flex justifyCenter alignCenter">
            <img src="../../pic/icon/plus.svg" alt="create-journal">
          </div>
          <div class="desc"><h2 class="title">Create Journal</h2></div>
        </div>
      </div>
    ...
    <section class="bottomNav">
      <nav class="flex justifyEven alignCenter">
        ...
        <div class="navButton active">
          <a class="flex justifyCenter alignCenter flexColumn" href="./journal.php">
            <svg id="journalNavBtn" class="active" width="32" height="35" viewBox="0 0 32 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <div class="navButton flex justifyCenter alignCenter flexColumn">
          <a class="flex justifyCenter alignCenter flexColumn" href="../setting/setting.php">
            <svg id="settingNavBtn" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
  ...
  <script src="../../js/journal/toggleCreate.js"></script>
