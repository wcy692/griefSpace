...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>View Journal | griefSpace</title>
  ...
  <body class="fontInter">
    ...
    <section id="previewPanel" class="container slide">
      <div class="rightBtnContainer flex">
        <img id="quitBtn" src="../../pic/icon/goBack.svg" alt="quit-question-selector">
      </div>
      <div class="head ">
        <div class="question editQuestion">
          <div class="detailHeading"></div>
          <div class="ansPreview">
            <h3>Answer: </h3>
            <h3 class="ansCount">You've submited answers for this question.</h3>
          </div>
        </div>
      </div>
    </section>

    <button class="fixedBtn editBtn"><img src="../../pic/icon/editBtn.svg" alt="edit-journal"></button>
  ...
  <script src="../../js/journal/readJournal.js"></script>
