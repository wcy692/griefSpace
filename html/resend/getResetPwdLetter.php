              ...
              if ($status != "success") {
                ...
                if ($status == 'empty') {
                  ...
                  echo '<h3>No request:</h3>
                        <h5>No request made for this username.</h5>';
                } elseif ($status == 'error') {
                  ...
                  echo '<h3>Time limit:</h3>
                        <h5>You can submit a request every 30 minutes.</h5>';
                } elseif ($status == 'sendErr') {
                  echo '<h3>Email error:</h3>
                        <h5>Oops... Email couldn\'t send out. Please contact out customer service.</h5>';
                }
                echo '</div>';
              }
