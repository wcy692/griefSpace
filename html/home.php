...
<html lang="en" dir="ltr">
  ...
  <body class="fontInter">
     ...
     <section class="container page">
       <h3 class="smallText">Welcome back</h3>
       <h1 class="heading">Why not check these out?</h1>
       <div class="boxWrapper">
         <div id="journalLink" class="homeBox flex flexColumn justifyStart alignCenter">
           <h2 class="title">Journalling</h2>
           <div class="imgContainer flex justifyCenter alignCenter">
             <img src="../pic/home/sliderHero/journal.svg" alt="journal">
           </div>
         </div>
         <div id="insightLink" class="homeBox flex flexColumn justifyStart alignCenter">
           <h2 class="title">Tracking</h2>
           <div class="imgContainer flex justifyCenter alignCenter">
             <img src="../pic/home/sliderHero/calendar.svg" alt="track-emotion">
           </div>
         </div>
       </div>
     </section>
     ...
     <section class="bottomNav">
       <nav class="flex justifyEven alignCenter ">
         <div class="navButton flex justifyCenter alignCenter flexColumn active">
           <a id="homeNavBtn" class="active" class="flex justifyCenter alignCenter flexColumn" href="../home.php">
