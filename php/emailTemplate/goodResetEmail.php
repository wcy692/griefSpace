         ...
         <div style='background: #FFFFFF;
            ...
            <div style='max-width: 80%;
                      ...
                      <h1 style='font-size: 48px;
                       ...
                       color: #9066E9;
                       margin-bottom: 32px;
                       line-height: 1.1;'>You've changed your password!</h1>
                       <p style='font-size: 20px;
                        margin: 8px 0;
                        line-height: 1.3;'>Hello there, this is a reminder that you just changed your password. From now on, you will have to log on your space using the new password. We look forward to seeing you again.</p>
