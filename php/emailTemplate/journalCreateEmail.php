         ...
         <div style='background: #FFFFFF;
            ...
            <div style='max-width: 80%;
                      ...
                      <h1 style='font-size: 48px;
                       ...
                       color: #9066E9;
                       margin-bottom: 32px;
                       line-height: 1.1;'>Activity alert: New journal created</h1>
                       <p style='font-size: 20px;
                        margin: 8px 0;
                        line-height: 1.3;
                        text-align:center;'>Hello there, this is a notification email to inform you just created your journal.
